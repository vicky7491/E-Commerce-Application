...
const Testimonials = () => {
  ...
  // Gallery items mapped to your folder structure
  ...
  return (
    ...
    <section className="w-full py-16 px-4 sm:px-8 bg-[#faf8f5] relative overflow-hidden">
      ...
      <motion.div 
        className="absolute -top-20 -right-20 w-60 h-60 rounded-full bg-[#f5ece0] opacity-50"
        animate={{ scale: [1, 1.1, 1] }}
        transition={{ duration: 8, repeat: Infinity }}
      />
      <motion.div 
        className="absolute bottom-10 left-0 w-40 h-40 rounded-full bg-[#f0e7db] opacity-30"
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-serif font-light text-[#4a3f35] mb-4">
            Cherished Impressions
          </h2>
          <p className="text-lg md:text-xl text-[#7a6a5a] max-w-3xl mx-auto font-sans">
            Each casting tells a unique story, preserving life's most precious moments 
            in timeless artistry.
          </p>
        </motion.div>
            ...
            <motion.button 
              ...
              className={`px-5 py-2.5 rounded-full font-sans ${
                activeCategory === category 
                  ? 'bg-[#d9a590] text-white' 
                  : 'text-[#4a3f35] border border-[#d9c9b8] hover:bg-[#e9ddd0]'
              } transition-all`}
            >
              {category}
            </motion.button>
              ...
              <div className="relative h-full w-full overflow-hidden bg-[#f0e7db]">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#4a3f35]/90 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                  <div>
                    ...
                    <span className="inline-block mt-3 px-3 py-1 bg-[#d9a590] rounded-full text-xs text-white font-sans">
                      {item.category}
                    </span>
                  </div>
                </div>
        ...
        >
          <motion.button
            whileHover={{ 
              ...
              color: "#fff",
              boxShadow: "0 10px 25px -5px rgba(217, 165, 144, 0.4)"
            }}
            whileTap={{ scale: 0.98 }}
            className="px-8 py-3.5 rounded-full font-sans text-[#d9a590] border border-[#d9a590] hover:bg-[#d9a590] hover:text-white transition-all"
          >
            View More Memories
          </motion.button>
        </motion.div>
                ...
                <div className="md:w-5/12 p-6 md:p-8 flex flex-col">
                  <div className="mb-6">
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className="px-3 py-1 bg-[#d9a590]/20 text-[#b2806d] rounded-full font-sans">
                        {selectedItem.category}
                      </span>
                    </div>
                    
                    <p className="text-[#7a6a5a] font-sans">
                      Each piece is meticulously hand-crafted by our artisans using 
                      premium materials that ensure your memories last a lifetime.
                    </p>
                  </div>
                  ...
                  <div className="mt-auto pt-6 border-t border-[#e6d6c5]">
                    ...
                    <p className="text-[#7a6a5a] font-sans mb-4">
                      Ready to create your own heirloom? Our casting kits make it easy 
                      to capture life's precious moments.
                    </p>
                    <motion.button 
